...
> Design notes for **ordered-commerce-tool-loop** — a runnable python example that A typed Python service that keeps e-commerce tool calls in a deterministic order.
...
- **Feature code** — the actual task: ecommerce-order-automation.
